...
USE `worthwise`;
-- MySQL dump for Aiven - Production Ready
-- Removed DEFINER clauses for managed MySQL compatibility
-- Host: Aiven MySQL
-- ------------------------------------------------------
-- Server version: 8.0.x (Aiven)
-- Generation Time: Mon Dec 01, 2025 at 22:46:48
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Branch campus and location data';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Geographic regions for cost-of-living adjustments';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping routines for database 'worthwise'
-- Removed DEFINER clauses for Aiven compatibility
--
DELIMITER ;;
CREATE PROCEDURE `sp_activate_data_version`(
...
DELIMITER ;;
CREATE PROCEDURE `sp_complete_etl_run`(
...
DELIMITER ;;
CREATE PROCEDURE `sp_start_etl_run`(
    IN p_run_id VARCHAR(50),
